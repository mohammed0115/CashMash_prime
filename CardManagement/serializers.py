...
from Consumer.serializers import BaseConsumerAPISerializer,BaseConsumerAPISerializer,PanValidator
from .models import RegisterVirualCard,Card

class Cardserializers(serializers.ModelSerializer):
    class Meta:
        model = Card
        fields = ['card_pan','card_expiry','card_user','card_label']
