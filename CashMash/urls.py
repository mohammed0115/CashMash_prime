...
urlpatterns = [
    ...
    path('AdminResetPassword/', views.AdminResetPassword.as_view()),
    path('MerchantRegistration/', views.MerchantRegistration.as_view()),
    path('MerchantTransactionStatus/', views.MerchantTransactionStatus.as_view()),
    path('AccountTransfer/', views.AccountTransfer.as_view()),
